  ...
  return new DefaultEmbedBuilder()
    ...
    .setFields([
      ...
      },
      {
        ...
        value: roleMention(
          getNested('roles.support', settings, translator('Not yet defined'))
        ),
        inline: true
      },
      {
      ...
      },
      {
        ...
        value: channelMention(
          getNested('channels.info', settings, translator('Not yet defined'))
        ),
        inline: true
      },
      {
        ...
        value: channelMention(
          getNested('menuInfo.channel', settings, translator('Not yet defined'))
        ),
        inline: true
      },
      {
      ...
      },
      {
        ...
        value: channelMention(
          getNested('logs.memberRole', settings, translator('Not yet defined'))
        ),
        inline: true
      },
      {
      ...
      },
      {
        ...
        value: channelMention(
          getNested('logs.voiceChat', settings, translator('Not yet defined'))
        ),
        inline: true
      }
    ]);
