export enum ESChangeButton {
  ...
  // LAUNCHER_DOWNLOAD_INSTALLER_LINK = 'admin_command_schange_button/launcher_download_installer_link',
  // LAUNCHER_DOWNLOAD_PORTABLE_LINK = 'admin_command_schange_button/launcher_download_portable_link',
  // MANUAL_FILES = 'admin_command_schange_button/manual_files',
  // SERVER_STATUS = 'admin_command_schange_button/server_status'
}