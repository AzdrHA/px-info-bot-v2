export enum ETicketSetCommand {
  ARCHIVED_CATEGORY = 'admin_command_set_button/ticket/archived_category',
  CATEGORY = 'admin_command_set_button/ticket/category',
  CHANNEL = 'admin_command_set_button/ticket/channel',
