...
import VerificationSetCommandButton from '@component/button/command/set-command/verification/VerificationSetCommandButton';

describe('VerificationSetCommandButton', () => {
  it('should return an array of button', async () => {
    const verificationSetCommandButtonBuilder =
      new VerificationSetCommandButton();
